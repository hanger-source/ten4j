...
public abstract class AbstractConnection implements Connection {
    ...
    public void onMessageReceived(Message message) {
        ...
        if (message.getSrcLoc() != null && message.getSrcLoc().getAppUri() != null && !message.getSrcLoc().getAppUri().isEmpty() && (this.uri == null || this.uri.isEmpty())) {
    ...
    public void attachToEngine(Engine engine) {
        ...
        log.info("Connection {}: 已依附于 Engine {}{}", connectionId, engine.getGraphId(), engine.getRunloop().getCoreThread() != null ? "，Runloop: " + engine.getRunloop().getCoreThread().getName() : "");
    }
    ...
    public void attachToRemote(Remote remote) { // 参数改为 Remote
        ...
        log.info("AbstractConnection {}: 依附到 Remote {}{}", connectionId, remote.getUri(), remote.getRunloop().getCoreThread() != null ? "，Runloop: " + remote.getRunloop().getCoreThread().getName() : "");
