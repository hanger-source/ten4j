...
public abstract class BaseRealtimeExtension extends BaseFlushExtension<RealtimeEvent> {
     ...
     */
    @Override
    protected void handleStreamItem(RealtimeEvent item, Message originalMessage, TenEnv env) {
        // 在子类中实现具体的事件分派逻辑
     ...
     */
    protected abstract void processRealtimeEvent(TenEnv env, RealtimeEvent event, Message originalMessage);
