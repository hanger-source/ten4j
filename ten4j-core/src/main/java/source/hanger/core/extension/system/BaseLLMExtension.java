...
public abstract class BaseLLMExtension extends BaseExtension {
    ...
    private QueueAgent<DataMessage> queueAgent;
    ...
    public void onConfigure(TenEnv env, Map<String, Object> properties) {
        ...
        this.queueAgent = QueueAgent.<DataMessage>create().subscribe(createDataMessageConsumer());
    }
    ...
    public void flushInputItems(TenEnv env) {
        queueAgent.shutdown();
        this.queueAgent = QueueAgent.create();
        this.queueAgent.subscribe(createDataMessageConsumer());
        queueAgent.start();
    ...
    protected abstract void onDataChatCompletion(TenEnv env, DataMessage data);
}