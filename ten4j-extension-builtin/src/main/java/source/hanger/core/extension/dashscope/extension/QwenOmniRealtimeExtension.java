...
import source.hanger.core.extension.dashscope.client.realtime.events.FunctionCallArgumentsDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.InputAudioBufferCommittedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.InputAudioBufferSpeechStartedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.InputAudioBufferSpeechStoppedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.InputAudioTranscriptionCompletedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ItemCreatedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.RealtimeEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.RealtimeEventType;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseAudioDeltaEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseAudioDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseAudioTranscriptDeltaEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseAudioTranscriptDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseContentPartAddedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseContentPartDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseCreatedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseOutputItemAddedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseOutputItemDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseTextDeltaEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.ResponseTextDoneEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.SessionCreatedEvent;
import source.hanger.core.extension.dashscope.client.realtime.events.SessionUpdatedEvent;
import source.hanger.core.extension.dashscope.client.realtime.messages.FunctionCallOutputItem;
import source.hanger.core.extension.dashscope.client.realtime.messages.InputAudioTranscription;
import source.hanger.core.extension.dashscope.client.realtime.messages.ItemCreateMessage;
import source.hanger.core.extension.dashscope.client.realtime.messages.ItemTruncateMessage;
import source.hanger.core.extension.dashscope.client.realtime.messages.ResponseCreateMessage;
import source.hanger.core.extension.dashscope.client.realtime.messages.ResponseCreateParams;
import source.hanger.core.extension.dashscope.client.realtime.messages.SessionUpdateMessage;
import source.hanger.core.extension.dashscope.client.realtime.messages.SessionUpdateParams;
import source.hanger.core.extension.dashscope.client.realtime.messages.TurnDetection;
 ...
 */
@Slf4j
public class QwenOmniRealtimeExtension extends BaseRealtimeExtension<RealtimeEvent> {
    ...
    private void handleResponseOutputItemAdded(TenEnv env, ResponseOutputItemAddedEvent event) {
        ...
        log.info(
            "[{}] Response Output Item Added: eventId={}, responseId={}, itemId={}, outputIndex={}, outputType={}, "
                + "contentParts={}",
    ...
    private void handleFunctionCallArgumentsDone(TenEnv env, FunctionCallArgumentsDoneEvent event,
        ...
        log.info(
            "[{}] Function Call Arguments Done: eventId={}, responseId={}, toolName={}, functionName={}, arguments={}",
            env.getExtensionName(), eventId, responseId, toolName, functionName, arguments);
