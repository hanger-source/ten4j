//package source.hanger.core.extension.refactor.dashscope.client.vision;
//
...
//import source.hanger.core.extension.api.BaseLLMToolExtension;
...
//            log.warn("{} Virtual thread executor is not initialized or shut down, skipping video frame processing
...
//                    } catch (InterruptedException e) {
//                        log.error("{} Interrupted while putting image to queue: {}", env.getExtensionName(), e
//                        .getMessage());
//                        Thread.currentThread().interrupt();
//                    }
//                } else {
